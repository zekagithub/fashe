 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="<?php echo base_url('assets/back/'); ?>
https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
        ...
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="<?php echo base_url('assets/back/'); ?>
javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
...
<!-- ChartJS -->
<script src="<?php echo base_url('assets/back/'); ?>
bower_components/chart.js/Chart.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo base_url('assets/back/'); ?>
dist/js/pages/dashboard2.js"></script>
